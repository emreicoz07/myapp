  ...
  return (
    <div className="home-container">
      ...
      <section className="about">
        <h2>About Us</h2>
        <p>
          We are a luxury beauty center offering a wide range of services to
          help you feel beautiful inside and out. From skincare to hair styling,
          we provide the best treatments with the highest quality products.
        </p>
      </section>
